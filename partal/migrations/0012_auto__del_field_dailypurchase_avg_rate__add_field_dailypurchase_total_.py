...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DailyPurchase.avg_rate'
        db.delete_column(u'partal_dailypurchase', 'avg_rate')

        # Adding field 'DailyPurchase.total_purchase_amount'
        db.add_column(u'partal_dailypurchase', 'total_purchase_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DailyPurchase.avg_rate'
        db.add_column(u'partal_dailypurchase', 'avg_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Deleting field 'DailyPurchase.total_purchase_amount'
        db.delete_column(u'partal_dailypurchase', 'total_purchase_amount')
    ...
    models = {
        ...
        u'partal.dailypurchase': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 4, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
