...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SaleInvoice.firm'
        db.add_column(u'partal_saleinvoice', 'firm',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=10),
                      keep_default=False)

        # Adding field 'SaleInvoice.net_loose_amount'
        db.add_column(u'partal_saleinvoice', 'net_loose_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'SaleInvoice.narration'
        db.add_column(u'partal_saleinvoice', 'narration',
                      self.gf('django.db.models.fields.TextField')(default='None'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SaleInvoice.firm'
        db.delete_column(u'partal_saleinvoice', 'firm')

        # Deleting field 'SaleInvoice.net_loose_amount'
        db.delete_column(u'partal_saleinvoice', 'net_loose_amount')

        # Deleting field 'SaleInvoice.narration'
        db.delete_column(u'partal_saleinvoice', 'narration')
    ...
    models = {
        ...
        u'partal.dailypurchase': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 7, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'partal.wasteproduct': {
            'Meta': {'object_name': 'WasteProduct'},
            'bags': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20', 'primary_key': 'True'}),
            'weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'})
        }
