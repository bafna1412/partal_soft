...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseInvoice.paid_with'
        db.add_column(u'partal_purchaseinvoice', 'paid_with',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseInvoice.paid_with'
        db.delete_column(u'partal_purchaseinvoice', 'paid_with')
