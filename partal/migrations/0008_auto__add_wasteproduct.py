...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WasteProduct'
        db.create_table(u'partal_wasteproduct', (
        ...
        db.send_create_signal(u'partal', ['WasteProduct'])


    def backwards(self, orm):
        # Deleting model 'WasteProduct'
        db.delete_table(u'partal_wasteproduct')
