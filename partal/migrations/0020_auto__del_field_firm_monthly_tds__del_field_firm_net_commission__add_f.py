...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Firm.monthly_tds'
        db.delete_column(u'partal_firm', 'monthly_tds')

        # Deleting field 'Firm.net_commission'
        db.delete_column(u'partal_firm', 'net_commission')

        # Adding field 'Firm.net_commission_APB'
        db.add_column(u'partal_firm', 'net_commission_APB',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Firm.net_commission_KY'
        db.add_column(u'partal_firm', 'net_commission_KY',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Firm.monthly_TDS_APB'
        db.add_column(u'partal_firm', 'monthly_TDS_APB',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Firm.monthly_TDS_KY'
        db.add_column(u'partal_firm', 'monthly_TDS_KY',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Firm.monthly_tds'
        db.add_column(u'partal_firm', 'monthly_tds',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Firm.net_commission'
        db.add_column(u'partal_firm', 'net_commission',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Deleting field 'Firm.net_commission_APB'
        db.delete_column(u'partal_firm', 'net_commission_APB')

        # Deleting field 'Firm.net_commission_KY'
        db.delete_column(u'partal_firm', 'net_commission_KY')

        # Deleting field 'Firm.monthly_TDS_APB'
        db.delete_column(u'partal_firm', 'monthly_TDS_APB')

        # Deleting field 'Firm.monthly_TDS_KY'
        db.delete_column(u'partal_firm', 'monthly_TDS_KY')
    ...
    models = {
        ...
        u'partal.dailypurchase': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
