...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessEntry.final_out'
        db.add_column(u'partal_processentry', 'final_out',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProcessEntry.pulse_weight'
        db.add_column(u'partal_processentry', 'pulse_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'ProcessEntry.pulse_bags'
        db.add_column(u'partal_processentry', 'pulse_bags',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProcessEntry.jhiri_weight'
        db.add_column(u'partal_processentry', 'jhiri_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'ProcessEntry.jhiri_bags'
        db.add_column(u'partal_processentry', 'jhiri_bags',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProcessEntry.danthal_weight'
        db.add_column(u'partal_processentry', 'danthal_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'ProcessEntry.danthal_bags'
        db.add_column(u'partal_processentry', 'danthal_bags',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProcessEntry.stone_weight'
        db.add_column(u'partal_processentry', 'stone_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'ProcessEntry.stone_bags'
        db.add_column(u'partal_processentry', 'stone_bags',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProcessEntry.short_weight'
        db.add_column(u'partal_processentry', 'short_weight',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessEntry.final_out'
        db.delete_column(u'partal_processentry', 'final_out')

        # Deleting field 'ProcessEntry.pulse_weight'
        db.delete_column(u'partal_processentry', 'pulse_weight')

        # Deleting field 'ProcessEntry.pulse_bags'
        db.delete_column(u'partal_processentry', 'pulse_bags')

        # Deleting field 'ProcessEntry.jhiri_weight'
        db.delete_column(u'partal_processentry', 'jhiri_weight')

        # Deleting field 'ProcessEntry.jhiri_bags'
        db.delete_column(u'partal_processentry', 'jhiri_bags')

        # Deleting field 'ProcessEntry.danthal_weight'
        db.delete_column(u'partal_processentry', 'danthal_weight')

        # Deleting field 'ProcessEntry.danthal_bags'
        db.delete_column(u'partal_processentry', 'danthal_bags')

        # Deleting field 'ProcessEntry.stone_weight'
        db.delete_column(u'partal_processentry', 'stone_weight')

        # Deleting field 'ProcessEntry.stone_bags'
        db.delete_column(u'partal_processentry', 'stone_bags')

        # Deleting field 'ProcessEntry.short_weight'
        db.delete_column(u'partal_processentry', 'short_weight')
    ...
    models = {
        ...
        u'partal.dailypurchase': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'partal.processentry': {
            ...
            'danthal_bags': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'danthal_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 3, 0, 0)'}),
            'final_out': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jhiri_bags': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'jhiri_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'percentage_out': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'process': ('django.db.models.fields.CharField', [], {'default': "'None'", 'max_length': '100'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['partal.Product']"}),
            'pulse_bags': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'pulse_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'short_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'stone_bags': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'stone_weight': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
        ...
        u'partal.purchaseinvoice': {
            ...
            'paid_with': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
